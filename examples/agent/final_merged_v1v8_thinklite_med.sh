...
VQA_RAD=/home/yuexi/projects/Med-VLM-R1/data/VQA_RAD/vqa_rad_train.parquet
SLAKE=/home/yuexi/projects/Med-VLM-R1/data/SLAKE/slake_train.parquet
OMVQA=/home/yuexi/projects/Med-VLM-R1/data/OmniMedVQA/QA_information/Open-access/omnimedvqa_train_4k.parquet
VQA_RAD_TEST=/home/yuexi/projects/Med-VLM-R1/data/VQA_RAD/vqa_rad_test.parquet

REF_MODEL_PATH=/data/yuexi/projects/DeepEyes/models/Qwen2.5-VL-7B-Instruct
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    +debug=False \
    +vs_debug=False \
    data.train_files=[${VQA_RAD},${SLAKE},${OMVQA}] \
    data.val_files=[${VQA_RAD_TEST}] \
    ...
    +actor_rollout_ref.rollout.format="safetensors" \
